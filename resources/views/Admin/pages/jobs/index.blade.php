...
@section('pageTitle') <i class="fa fa-user-plus"></i> {{ trans('backend.jobs') }} @endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">
                {{ trans('backend.info') }} {{ trans('backend.jobs') }}
                                ...
                                <td>
                                    <div class="btn-group manage-button" title="View Account">
                                        ...
                                        <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                                            <li>
                                                <a title="{{ trans('backend.edit') }} {{ trans('backend.record') }}" href="{{ route('jobs.edit' , $worker->id) }}">
                                                    <i class="fa fa-fw fa-pencil"></i> {{ trans('backend.edit') }}
                                                </a>
                                            </li>

                                            <li>
                                                <form action="{{ route('jobs.destroy' , $worker->id) }}" method="POST" style="display:inline">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
